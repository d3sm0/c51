...
from tf_utils import fc, p_to_q, build_z, get_trainable_variables, get_pa

class DQN(object):
    def __init__(self, name, obs_dim, acts_dim, gamma=.95, v_min=0, v_max=25., n_atoms=11,
                 nb_units=(64, 64, 64),
                 act=tf.nn.relu):
        self.scope = name
    ...
    def __train_op(self, batch_size=64, lr=1e-3, max_clip=40.):
        ...
        self.cross_entropy = tf.reduce_mean(tf.reduce_sum(-self.thtz * tf.log(p_target), axis=-1),
